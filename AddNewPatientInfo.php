...
if(isset($_POST['submit'])){
    ...
    if (isset($_SESSION['id'])) {
        ...
        if (mysqli_num_rows($checkResult) > 0) {
            ...
            $sql = "UPDATE addpatient SET name='$name', '$drname', age='$age', experience='$experience' WHERE id='$doctorID'";
        } else {
                ...
                <div class="card">
                    <div class="card-body">
                     ...
                     <form id="addpatient" method="post" action="addNewPatientInfo.php">
                            ...
                            <div class="note-div">
                                <p>Please note that providing accurate information is crucial. Providing wrong information may lead to strict actions. Make sure to use an active email address for communication.</p>
                            </div>

<!-- name -->
<div class="mb-3 row align-items-center">
    <label class="col-sm-2 col-form-label"><i class="fa fa-stethoscope"></i> Name:</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" placeholder="dr.name" name="drname" autocomplete="off" value="<?php echo $drname; ?>">
    </div>
</div>
                     <!-- Email -->
<div class="mb-3 row align-items-center">
...
<!-- Age -->
<div class="mb-3 row align-items-center">
    <label class="col-sm-2 col-form-label"><i class="bi bi-person-fill"></i> Age:</label>
    <div class="col-sm-10">
