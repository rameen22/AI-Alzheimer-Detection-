...
//if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO prescriptions(doctorname, patientname, age, disease, stage, prescription)
    values('$doctorname', '$patientname', '$age', '$disease', '$stage', '$prescription')";
   ...
   <div class="container my-2">
        <form id="AddPatientRecord" class="input" method="post">
            ...
            <h2 class="text-center mb-4"><i class="fas fa-book-medical"></i>  Add Patient Record</h2>
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" id="doctorname" placeholder="Enter Doctor Name" name="doctorname"
