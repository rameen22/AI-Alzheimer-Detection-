...
if (isset($_SESSION['username'], $_SESSION['email'], $_SESSION['password'], $_SESSION['usertype'], $_SESSION['otp'], $_SESSION['activation_code'])) {
    ...
    if (isset($_POST['verify'])) {
        ...
        if ($entered_otp == $otp) {
            ...
            $sqlInsert = "INSERT INTO registration (username, email, password, usertype, otp, activationcode, status) VALUES ('$username', '$email', '$password', '$usertype', '$otp', '$activation_code', 'active')";
