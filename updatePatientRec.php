...
if (isset($_POST['submit'])) {
     ...
     // Assuming you have a hidden input field with the id in your form
    $name = $_POST['name'];
    $email = $_POST['email'];
    ...
    $sql = "UPDATE newpatient set name='$name',email='$email', age='$age', gender='$gender', `inherited`='$inherited' WHERE id=$id";
    $result = mysqli_query($con, $sql);
    ...
    <div class="banner">
        <div class="d-flex" id="wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light py-2 px-4" style="background-color: white;">
                ...
                <div class="container my-4 addnew" >
    <form id="addpatient" class="input" method="post">

        <div class="row mb-3">
            <label class="col-sm-2 col-form-label">Name:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Enter Patient Name" name="name" autocomplete="off">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 col-form-label">Email:</label>
            <div class="col-sm-10">
                <input type="email" class="form-control" placeholder="Enter Patient email" name="email" autocomplete="off">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Enter Patient Age" name="age" autocomplete="off">
            </div>
        </div>
